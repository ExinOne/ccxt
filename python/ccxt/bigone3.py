...
class bigone3 (Exchange):
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetAssetPairsSymbolTicker(self.extend(request, params))
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.publicGetAssetPairsSymbolDepth(self.extend(request, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetAssetPairsSymbolTrades(self.extend(request, params))
        #    {
        #        "code": 0,
        #        "data": [{
        #            "id": 38199941,
