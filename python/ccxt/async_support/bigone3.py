...
class bigone3 (Exchange):

    def describe(self):
        return self.deep_extend(super(bigone3, self).describe(), {
            'id': 'bigone3',
            'name': 'BigONE',
            'countries': ['GB'],
            'version': 'v3',
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.publicGetAssetPairsSymbolTicker(self.extend(request, params))
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.publicGetAssetPairsSymbolDepth(self.extend(request, params))
        return self.parse_order_book(response['data'], None, 'bids', 'asks', 'price', 'quantity')
    ...
    def parse_trade(self, trade, market=None):
        ...
        if timestamp is None:
            ...
            timestamp = self.parse8601(self.safe_string(trade, 'inserted_at'))
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = await self.publicGetAssetPairsSymbolTrades(self.extend(request, params))
        #    {
        #        "code": 0,
        #        "data": [{
        #            "id": 38199941,
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        #    page_token       string  False       request page after self page token
